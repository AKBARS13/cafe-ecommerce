            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="account_holder" value="{{ old('account_holder') }}" required
                        placeholder="Contoh: PT Cafe Kopi Nusantara"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-amber-500">
                </div>
                ...
                <div>
                    ...
                    <textarea name="notes" rows="2"
                        placeholder="Catatan untuk customer, misal: Transfer ke rekening ini sebelum jam 22:00"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-amber-500">{{ old('notes') }}</textarea>
                </div>
